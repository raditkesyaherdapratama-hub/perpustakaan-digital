    ...
    <div class="mx-auto max-w-7xl">
            ...
            <div class="relative z-10 flex flex-col justify-between gap-8 md:flex-row md:items-center">
                <div>
                    ...
                    <p class="mt-4 max-w-xl text-sm leading-6 text-emerald-100/80">
                        Kelola seluruh aktivitas perpustakaan MI Al Falahiyyah Rajeg dengan lebih cepat, mudah, dan terorganisir.
                    </p>
                </div>
        ...
        <div class="mb-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="group relative overflow-hidden rounded-3xl border border-green-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-green-200 hover:shadow-xl">
                ...
                <div class="relative">
                    ...
                    <div class="mt-4 flex items-center gap-2 text-xs font-medium text-green-600">
                        <span class="flex h-5 w-5 items-center justify-center rounded-full bg-green-100">✓</span>
            ...
            <div class="group relative overflow-hidden rounded-3xl border border-teal-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-teal-200 hover:shadow-xl">
                ...
                <div class="relative">
                    ...
                    <div class="mt-4 flex items-center gap-2 text-xs font-medium text-teal-600">
                        <span class="flex h-5 w-5 items-center justify-center rounded-full bg-teal-100">↗</span>
            ...
            <div class="group relative overflow-hidden rounded-3xl border border-lime-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-lime-200 hover:shadow-xl">
                ...
                <div class="relative">
                    ...
                    <p class="text-sm font-medium text-slate-500">Pengembalian</p>
                    <h2 class="mt-2 text-4xl font-extrabold tracking-tight text-slate-900">
                        {{ $totalPengembalian ?? 0 }}
                    </h2>
                    <div class="mt-4 flex items-center gap-2 text-xs font-medium text-lime-600">
                        <span class="flex h-5 w-5 items-center justify-center rounded-full bg-lime-100">✓</span>
        ...
        <div class="grid gap-8 lg:grid-cols-3">
            ...
            <div class="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm lg:col-span-1">
                ...
                <div class="space-y-3">
                    {{-- TAMBAH BUKU --}}
                    <a href="{{ route('buku.create') }}" class="group flex items-center gap-4 rounded-2xl border border-slate-100 p-3.5 transition duration-200 hover:border-emerald-200 hover:bg-emerald-50">
                        <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-emerald-100 text-lg transition group-hover:bg-emerald-600 group-hover:text-white">
                            ➕
                        </div>
                        <div class="flex-1">
                            <p class="text-sm font-semibold text-slate-800">Tambah Buku</p>
                            <p class="text-xs text-slate-500">Input koleksi buku baru</p>
                        </div>
                        <span class="text-slate-400 transition group-hover:translate-x-1 group-hover:text-emerald-600">→</span>
                    </a>

                    {{-- KELOLA BUKU --}}
                    <a href="{{ route('buku.index') }}" class="group flex items-center gap-4 rounded-2xl border border-slate-100 p-3.5 transition duration-200 hover:border-green-200 hover:bg-green-50">
                        <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-green-100 text-lg transition group-hover:bg-green-600 group-hover:text-white">
                            📚
                        </div>
                        <div class="flex-1">
                            <p class="text-sm font-semibold text-slate-800">Kelola Buku</p>
                            <p class="text-xs text-slate-500">Lihat & edit katalog buku</p>
                        </div>
                        <span class="text-slate-400 transition group-hover:translate-x-1 group-hover:text-green-600">→</span>
                    </a>

                    {{-- KELOLA KATEGORI --}}
                    @if(Route::has('kategori.index'))
                    <a href="{{ route('kategori.index') }}" class="group flex items-center gap-4 rounded-2xl border border-slate-100 p-3.5 transition duration-200 hover:border-teal-200 hover:bg-teal-50">
                        <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-teal-100 text-lg transition group-hover:bg-teal-600 group-hover:text-white">
                            🏷️
                        </div>
                        <div class="flex-1">
                            <p class="text-sm font-semibold text-slate-800">Kelola Kategori</p>
                            <p class="text-xs text-slate-500">Atur kategori & genre buku</p>
                        </div>
                    ...
                    <a href="{{ route('anggota.index') }}" class="group flex items-center gap-4 rounded-2xl border border-slate-100 p-3.5 transition duration-200 hover:border-cyan-200 hover:bg-cyan-50">
                        <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-cyan-100 text-lg transition group-hover:bg-cyan-600 group-hover:text-white">
                            👥
                        </div>
                        <div class="flex-1">
                            <p class="text-sm font-semibold text-slate-800">Data Anggota</p>
                            <p class="text-xs text-slate-500">Kelola pengguna terdaftar</p>
                        </div>
                        <span class="text-slate-400 transition group-hover:translate-x-1 group-hover:text-cyan-600">→</span>
                    </a>
                    @endif

                    {{-- PENGEMBALIAN BUKU --}}
                    <a href="{{ route('pengembalian.index') }}" class="group flex items-center gap-4 rounded-2xl border border-slate-100 p-3.5 transition duration-200 hover:border-lime-200 hover:bg-lime-50">
                        <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-lime-100 text-lg transition group-hover:bg-lime-600 group-hover:text-white">
                            🔄
                        </div>
                        <div class="flex-1">
                            <p class="text-sm font-semibold text-slate-800">Pengembalian</p>
                            <p class="text-xs text-slate-500">Proses kembalikan & denda</p>
                        </div>
                        <span class="text-slate-400 transition group-hover:translate-x-1 group-hover:text-lime-600">→</span>
                    </a>

                    {{-- LAPORAN --}}
                    @if(Route::has('laporan.index'))
                    <a href="{{ route('laporan.index') }}" class="group flex items-center gap-4 rounded-2xl border border-slate-100 p-3.5 transition duration-200 hover:border-emerald-200 hover:bg-emerald-50">
                        <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-emerald-100 text-lg transition group-hover:bg-emerald-600 group-hover:text-white">
                            📊
                        </div>
                        <div class="flex-1">
                            <p class="text-sm font-semibold text-slate-800">Cetak Laporan</p>
                            <p class="text-xs text-slate-500">Rekapitulasi transaksi</p>
                        </div>
                        <span class="text-slate-400 transition group-hover:translate-x-1 group-hover:text-emerald-600">→</span>
                    </a>
                    @endif
                ...
                <div class="relative z-10">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div class="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm transition hover:bg-white/10">
                            <p class="text-xs font-medium text-emerald-200/60">INSTITUSI</p>
                            <p class="mt-2 text-lg font-semibold">MI Al Falahiyyah Rajeg</p>
                        </div>

                        {{-- ROLE --}}
                        <div class="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm transition hover:bg-white/10">
                            <p class="text-xs font-medium text-emerald-200/60">ROLE AKTIF</p>
                            <p class="mt-2 text-lg font-semibold capitalize">{{ auth()->user()->role ?? 'Admin' }}</p>
                        </div>

                        {{-- STATUS --}}
                        <div class="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm transition hover:bg-white/10">
                            <p class="text-xs font-medium text-emerald-200/60">STATUS SISTEM</p>
                        ...
                        {{-- TAHUN --}}
                        <div class="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm transition hover:bg-white/10">
                            <p class="text-xs font-medium text-emerald-200/60">TAHUN SISTEM</p>
                            <p class="mt-2 text-lg font-semibold">{{ date('Y') }}</p>
                        </div>
                    </div>
