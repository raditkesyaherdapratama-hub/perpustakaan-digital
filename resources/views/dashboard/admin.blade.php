...
<div class="min-h-screen bg-slate-50 px-4 py-6 font-['Inter',sans-serif] sm:px-6 lg:px-8">
    <div class="mx-auto max-w-7xl">
        ...
        <div class="mb-8 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="group relative overflow-hidden rounded-3xl border border-slate-100 bg-gradient-to-br from-white via-slate-50/50 to-emerald-50/30 p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-emerald-200 hover:shadow-xl hover:shadow-emerald-500/10">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-xs font-semibold tracking-wide uppercase text-slate-400">Total Buku</p>
                    ...
                    <div class="mt-4 flex items-center gap-2 text-xs font-medium text-emerald-700">
                        <span class="flex h-5 w-5 items-center justify-center rounded-full bg-emerald-100 text-emerald-600">✓</span>
            ...
            <div class="group relative overflow-hidden rounded-3xl border border-slate-100 bg-gradient-to-br from-white via-slate-50/50 to-blue-50/30 p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-500/10">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-xs font-semibold tracking-wide uppercase text-slate-400">Total Anggota</p>
                    <h2 class="mt-1 text-4xl font-black tracking-tight text-slate-900">
                        {{ $totalAnggota ?? 0 }}
                    </h2>
            ...
            <div class="group relative overflow-hidden rounded-3xl border border-slate-100 bg-gradient-to-br from-white via-slate-50/50 to-amber-50/30 p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-amber-200 hover:shadow-xl hover:shadow-amber-500/10">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-xs font-semibold tracking-wide uppercase text-slate-400">Buku Dipinjam</p>
                    <h2 class="mt-1 text-4xl font-black tracking-tight text-slate-900">
                        {{ $bukuDipinjam ?? 0 }}
                    </h2>
                    <div class="mt-4 flex items-center gap-2 text-xs font-medium text-amber-700">
                        <span class="flex h-5 w-5 items-center justify-center rounded-full bg-amber-100 text-amber-600">↗</span>
                        Sedang dipinjam
                    </div>
                </div>
            </div>
            ...
            <div class="group relative overflow-hidden rounded-3xl border border-slate-100 bg-gradient-to-br from-white via-slate-50/50 to-purple-50/30 p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-purple-200 hover:shadow-xl hover:shadow-purple-500/10">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-xs font-semibold tracking-wide uppercase text-slate-400">Pengembalian</p>
                    <h2 class="mt-1 text-4xl font-black tracking-tight text-slate-900">
                        {{ $totalPengembalian ?? 0 }}
                    </h2>
                    <div class="mt-4 flex items-center gap-2 text-xs font-medium text-purple-700">
                        <span class="flex h-5 w-5 items-center justify-center rounded-full bg-purple-100 text-purple-600">✓</span>
                        Buku dikembalikan
                    </div>
                </div>
            </div>
        ...
        {{-- ========================================================= --}}
        {{-- INFORMASI RINGKAS (BUKU TERLAMBAT, TOTAL DENDA, BUKU POPULER) --}}
        {{-- ========================================================= --}}
        <div class="mb-8 grid gap-6 lg:grid-cols-3">
            ...
            <div class="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
                <div class="mb-6 flex items-start justify-between">
                    <div>
                        <p class="text-xs font-bold uppercase tracking-widest text-emerald-600">PERHATIAN</p>
                        <h2 class="mt-2 text-xl font-extrabold text-slate-900">Buku Terlambat ⏰</h2>
                        <p class="mt-1 text-sm text-slate-500">Peminjaman yang melewati batas waktu</p>
                    </div>
                ...
                @if (($bukuTerlambat ?? 0) > 0)
                    <div class="rounded-2xl border border-red-100 bg-red-50 p-4">
                        <div class="flex items-center gap-3">
                            <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-red-100 text-lg">⚠️</div>
                            <div>
                                <p class="text-sm font-bold text-red-700">Ada buku terlambat</p>
                                <p class="mt-1 text-xs text-red-600">Segera periksa menu pengembalian.</p>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="rounded-2xl border border-green-100 bg-green-50 p-4">
                        <div class="flex items-center gap-3">
                            <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-green-100 text-lg">✓</div>
                            <div>
                                <p class="text-sm font-bold text-green-700">Tidak ada buku terlambat</p>
                                <p class="mt-1 text-xs text-green-600">Semua peminjaman berjalan dengan baik.</p>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div class="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
                <div class="mb-6">
                    <p class="text-xs font-bold uppercase tracking-widest text-emerald-600">KEUANGAN</p>
                    <h2 class="mt-2 text-xl font-extrabold text-slate-900">Total Denda 💰</h2>
                    <p class="mt-1 text-sm text-slate-500">Akumulasi denda keterlambatan</p>
                </div>

                <div class="rounded-2xl bg-gradient-to-br from-red-50 to-orange-50 p-5">
                    <p class="text-xs font-semibold uppercase tracking-wider text-red-500">Total Saat Ini</p>
            ...
            <div class="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
                <div class="mb-5">
                    <p class="text-xs font-bold uppercase tracking-widest text-emerald-600">STATISTIK</p>
                    <h2 class="mt-2 text-xl font-extrabold text-slate-900">Buku Populer 🔥</h2>
                    <p class="mt-1 text-sm text-slate-500">Buku yang paling sering dipinjam</p>
                </div>
        ...
        {{-- ========================================================= --}}
        {{-- GRAFIK KURVA TREN PEMINJAMAN (DIPINDAHKAN KE BAWAH BOX DENDA) --}}
        {{-- ========================================================= --}}
        <div class="mb-8 overflow-hidden rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
            <div class="mb-6 flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-extrabold text-slate-900">Kurva Tren Peminjaman Buku</h2>
                        <p class="text-xs text-slate-500">Grafik statistik transaksi peminjaman buku tahun {{ date('Y') }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2 self-start rounded-2xl bg-emerald-50 px-4 py-2 ring-1 ring-inset ring-emerald-600/20 sm:self-auto">
                    ...
                    <span class="text-xs font-bold text-emerald-700">Tahun {{ date('Y') }}</span>
                </div>
            </div>
        ...
        <div class="mb-8 overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm">
            ...
            <div class="flex flex-col justify-between gap-3 border-b border-slate-100 p-6 sm:flex-row sm:items-center">
                <div>
                    <p class="text-xs font-bold uppercase tracking-widest text-emerald-600">AKTIVITAS</p>
                    <h2 class="mt-2 text-xl font-extrabold text-slate-900">Peminjaman Terbaru 📋</h2>
                    <p class="mt-1 text-sm text-slate-500">Aktivitas peminjaman terakhir</p>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        <thead class="bg-slate-50/80">
                            <tr>
                                <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500">Anggota</th>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-[11px] text-slate-400">Anggota</p>
                                            </div>
                                        </div>
                                    </td>
            ...
            @else
                <div class="flex min-h-48 items-center justify-center p-6 text-center">
                    <div>
                        ...
                        <p class="text-sm font-semibold text-slate-500">Belum ada aktivitas peminjaman.</p>
                        <p class="mt-1 text-xs text-slate-400">Data peminjaman akan muncul di sini.</p>
                    </div>
                </div>
            @endif
        </div>
        ...
        <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-green-950 via-green-900 to-emerald-900 p-8 text-white shadow-xl">
            ...
            <div class="relative z-10">
                <div class="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                        <p class="text-xs font-bold uppercase tracking-widest text-green-300">SYSTEM OVERVIEW</p>
                        <h2 class="mt-2 text-2xl font-extrabold">Perpustakaan Digital</h2>
                    </div>
                ...
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
                        <p class="text-xs font-medium text-green-300">Institusi</p>
                        <p class="mt-2 text-sm font-bold">MI Al Falahiyyah Rajeg</p>
                    </div>

                    {{-- Role --}}
                    <div class="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
                        <p class="text-xs font-medium text-green-300">Role Aktif</p>
                        <p class="mt-2 text-sm font-bold capitalize">{{ auth()->user()->role }}</p>
                    </div>

                    {{-- Status --}}
                    <div class="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
                        <p class="text-xs font-medium text-green-300">Status Sistem</p>
                    ...
                    {{-- Tahun --}}
                    <div class="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
                        <p class="text-xs font-medium text-green-300">Tahun Sistem</p>
                        <p class="mt-2 text-sm font-bold">{{ date('Y') }}</p>
                    </div>
                </div>
                ...
                <div class="mt-6 rounded-2xl border border-green-400/20 bg-green-400/10 p-5">
                    <p class="text-sm leading-6 text-green-100">
                        💡 <span class="font-bold text-white">Tips:</span>
        ...
        new Chart(ctx, {
            ...
            options: {
                ...
                scales: {
                    ...
                    y: {
                        grid: { color: '#f1f5f9' },
                        ticks: { font: { family: 'Inter', size: 11, weight: '600' }, color: '#94a3b8', precision: 0 },
                        beginAtZero: true
                    }
                }
            }
